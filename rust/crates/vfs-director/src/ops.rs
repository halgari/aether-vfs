...
pub use vfs_protocol::{
    ...
    VPath, KIND_DIR, KIND_FILE, KIND_TOMBSTONE, OPEN_CREATE, OPEN_EXCL, OPEN_READ, OPEN_TRUNC,
    OPEN_WRITE, ST_BAD_FH, ST_BAD_REQUEST, ST_EXISTS, ST_IO_ERROR, ST_IS_DIR, ST_NOT_A_DIRECTORY,
    ST_NOT_FOUND, ST_NOT_SUPPORTED, ST_OK, ST_READ_ONLY,
};
